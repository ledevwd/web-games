window.onload = () => {
    ...
    let btnMachine = document.querySelector("#machine");
    ...
    let gameModeBlock = document.querySelector("#game-mode-block");
    ...
    function PlayAgainstTheMachine() {
        gameModeBlock.style.display = "none";
